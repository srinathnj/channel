...
const HeaderItem = () => {
    ...
    <div className="bg-red-800">
        <h3 className="text-center text-sm-start">Tech Summit Academy</h3>
        ...
        <i class="bi bi-twitter-x"></i><span className="text-white d-none d-sm-inline">@channelname</span>
    </a></li>
            <li> <a href="mailto:something@something.com" target="_blank" aria-label="email">
        <i class="fw-bold bi bi-envelope"></i> <span className="text-white d-none d-sm-inline"> something@something.com</span></a>
        </li>
            <li><a href="https://www.facebook.com/groups/srinathnj/" target="_blank" aria-label="Facebook">
        <i class="bi bi-facebook"></i><span className="text-white d-none d-sm-inline">classname</span></a></li>
            <li><a href="https://www.youtube.com/" target="_blank" aria-label="YouTube">
        <i class="bi bi-youtube"></i><span className="text-white d-none d-sm-inline">@channelname</span>
    </a></li>
            <li className="text-white d-none d-sm-inline">17 Natesan Street, Chennai - 600 117 </li>
        </ul>
        <div className="text-white d-block line-ht-1 text-center d-sm-none py-0">17 Natesan Street, Chennai - 600 117 </div>
    </div>
