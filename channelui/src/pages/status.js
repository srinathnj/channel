...
class Status_Page extends Component {
  constructor(props){
    super(props);
  ...
  {/*  <section class="vh-100" style="background-color: #8c9eff;">*/}
      <section class="vh-100 bg-primay">
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12">
        {/*<div class="card card-stepper" style="border-radius: 16px;">*/}
          <div class="card card-stepper bg-decondary" >

            <div class="card-body p-5">

              <div class="d-flex justify-content-between align-items-center mb-5">
                <div>
                  <h5 class="mb-0">INVOICE <span class="text-primary font-weight-bold">#{this.props.router.params.orderref}</span></h5>
                </div>
                <div class="text-end">
...
export default Status_Page = withRouter(Status_Page);
